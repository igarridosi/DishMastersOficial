...
const Footer = () => (
<footer className="bg-body-secondary text-center w-100 mt-3 rounded-md">
    <div className="container p-4 pb-0 col-8 d-flex justify-content-center">
        <section className="mb-4 d-flex justify-content-around w-50">
            ...
            <svg className="w-[20px] h-[20px] fill-[#ffffff]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
            <path d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z"></path>
            </svg>
            </a>
            <a className="btn text-white" style={{ backgroundColor: '#222222' }} href="#!">
            <svg className="w-[20px] h-[20px] fill-[#ffffff]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"></path>

            </svg>
            </a>
            <a className="btn text-white" style={{ backgroundColor: '#dd4b39' }} href="#!">
            <svg className="w-[20px] h-[20px] fill-[#ffffff]" viewBox="0 0 488 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="w-[20px] h-[20px] fill-[#ffffff]" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
