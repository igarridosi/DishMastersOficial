...
export default function UserForm() {
    ...
    return (
        ...
        <div className="card bg-white p-6 rounded-lg shadow-md animate__animated animate__fadeInDown">
            {loading && (
            <div className="text-center text-gray-500"><button type='button' class='py-2.5 px-4 inline-flex justify-center items-center gap-2 bg-[#FFBD59] text-black rounded-lg cursor-pointer font-semibold text-base text-center shadow-xs transition-all duration-500'>
